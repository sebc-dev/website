/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: d4bb5f236851f3fcaa2c23fa69248a73)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DOQueueHandler" | "DOTagCacheShard";
	}
	interface Env {
		NEXTJS_ENV: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler from website */;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOTagCacheShard from website */;
